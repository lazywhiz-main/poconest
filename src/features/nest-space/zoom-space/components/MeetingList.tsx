      ...
      >
        <View style={styles.meetingHeader}>
          ...
          <View 
            style={[
              styles.statusBadge,
              { backgroundColor: statusColors[item.status] || '#757575' }
            ]}
          >
          ...
          <View style={styles.filterOptions}>
            {Object.entries(statusLabels).map(([status, label]) => (
              <TouchableOpacity
                ...
                style={[
                  styles.filterButton,
                  statusFilter.includes(status) && styles.activeFilterButton
                ]}
              ...
              >
                <Text 
                  style={[
                    ...
                    statusFilter.includes(status) && styles.activeFilterButtonText
                  ]}
                >
                  {label}
                </Text>
