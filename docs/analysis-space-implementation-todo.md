...
### Phase 1: メインメニュー構造変更 ⭐ 優先度：HIGH
- [ ] **P1.1** 現在の横並びボタン群の調査と整理
- [ ] **P1.2** 5つのメインカテゴリーボタンの作成
  - Relations 🔗
  - Clustering 🎛️
  - Theory Building 🧠
  - View & Navigation 🗺️
  - Search & Filter 🔍
- [ ] **P1.3** サイドピーク共通コンポーネントの設計・実装
- [ ] **P1.4** メインメニューとサイドピークの基本動作確認

### Phase 2: Relations サイドピーク実装 ⭐ 優先度：HIGH
- [ ] **P2.1** Relations関連機能の現状調査
  - 🔗 統合関係性分析（増分）
  - 🗑️ Relations一括削除
  - 🧹 Relations重複削除
  - 🎛️ パラメータ設定
...
- ✅ **gitプッシュ完了** - コミット: `06265e72`
- ⏳ **実装フェーズ開始準備**

### 次のアクション
1. **Phase 1: メインメニュー構造変更** から開始
2. 各フェーズ完了後に動作確認
3. 問題があれば即座に修正・調整
